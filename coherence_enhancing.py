...
for image in images:
    ...
    speckle_0_80 = f"{OUTPUT_FOLDER}/{image[:-4]}/speckle_0_50/_speckle_0_50.jpg"
    speckle_0_200 = f"{OUTPUT_FOLDER}/{image[:-4]}/speckle_0_50/_speckle_0_50.jpg"
    ...
    noised_image = Image.open(speckle_0_50)
    ...
    noised_image = Image.open(speckle_0_80)
    output: np.ndarray = anisodiff(noised_image, niter=niter, kappa=k, gamma=g, option=fonction, ploton=False)
    ...
    noised_image = Image.open(speckle_0_200)
    output: np.ndarray = anisodiff(noised_image, niter==niter, kappa=k, gamma=g, option=fonction, ploton=False)
